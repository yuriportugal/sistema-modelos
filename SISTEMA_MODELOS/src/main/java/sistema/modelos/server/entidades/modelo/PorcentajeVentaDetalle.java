 ...
 */
@Entity
@Table(name = "DETALLE_PORC_VENTA")
public class PorcentajeVentaDetalle implements Serializable{
   
    @EmbeddedId
    private DetailTCPK detailTCPK;
    
    @Column(name = "PORC_VENTA")
    private Long porcVenta;
    ...
    public Long getPorcVenta() {
        return porcVenta;
    }

    public void setPorcVenta(Long porcVenta) {
